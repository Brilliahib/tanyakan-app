...
export default function MyApp() {
  return (
    <>
      <Navbar />
      <div>
        <div className="flex px-4 justify-center text-center my-12 md:py-24">
          <div className="">
            <div className="hero-text max-w-3xl">
              ...
              <p className="text-base text-gray-500 text-base mb-6 md:mb-8">
                ...
                kesenangan dan keceriaan. Bergabunglah untuk menikmati
                momen-momen yang menyenangkan dan penuh tawa!
              </p>
